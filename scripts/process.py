...
【カテゴリキー（9種のいずれか）】
ai_product   … OpenAI・Google・Anthropic・Microsoft・Meta・Apple等、大手AIベンダーの公式発表・新製品・モデルリリース・研究論文
ai_business  … Qiita・note・Zenn・個人ブログ等の実用記事。AIツールの使い方・プロンプト術・業務活用Tips等、知っていると得する実践情報
neuro_social / neuro_press / neuro_embodiment / neuro_psychology / neuro_ai /
competitor_press / industry_trend

※ ai_product は「ベンダー公式の発表」に限定。実用Tips・ハウツー記事は必ず ai_business に分類すること。
